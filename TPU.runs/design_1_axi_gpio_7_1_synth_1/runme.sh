...
HD_PWD='E:/Vivado/TPU/TPU.runs/design_1_axi_gpio_7_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_gpio_7_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_gpio_7_1.tcl
